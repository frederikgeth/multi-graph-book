...
| Behavioral reduction | Elimination of hidden variables preserving a declared external relation | [Projection, compilation, and reduction](@ref projection-compilation-reduction) |
| Approximate reduction | Reduction with a stated observation domain, metric and error | [Projection, compilation, and reduction](@ref projection-compilation-reduction) |
