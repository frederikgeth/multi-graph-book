...
![Scalar parallel-branch feasible-set geometry: the naive aggregate is an outer relaxation, while exact lifting restores the source interval.](../assets/parallel-feasible-set-card.png)
