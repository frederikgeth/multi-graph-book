...
include(joinpath(@__DIR__, "transformations", "TransformerTapACIndependentReproduction.jl"))
...
const OUTPUT = joinpath(
    @__DIR__, "generated", "transformer-tap-three-scenario-independent-certificate.json",
)
case = load_transformer_tap_ac_case()
certificate = independent_transformer_tap_three_scenario_certificate(case)
