...
"""
    lines = [
        ...
        '<circle cx="118" cy="300" r="35" class="label"/><circle cx="300" cy="300" r="35" class="label"/>',
        text(118, 306, "source", "small", "middle"), text(300, 306, "load", "small", "middle"),
        '<path d="M153 300 L265 300" class="arrow"/>', text(209, 282, "ℓmain", "small", "middle"),
        text(58, 390, "Yᴺij is a labelled block map", "body"),
        text(58, 420, "i,j ∈ B; it is not yet an array position", "small"),
